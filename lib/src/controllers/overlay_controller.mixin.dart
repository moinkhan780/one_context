...
mixin OverlayController {
  ...
  Future<String> addOverlay(
      {required String overlayId, required Widget Function(BuildContext context) builder, OverlayEntry? below, OverlayEntry? above}) async {
    await Future.delayed(Duration.zero, () {});
    OverlayState overlayState = Overlay.of(OneContext().context!);
  ...
  Future<OverlayEntry> showProgressIndicator(
      {Widget Function(BuildContext? context)? builder, Color? backgroundColor, Color? circularProgressIndicatorColor, bool allowDismiss = false}) {
    return showOverlay(
        builder: (_) => Stack(
              children: <Widget>[
                ModalBarrier(
                ...
                builder != null
                    ...
                    : Center(
                        ...
                        valueColor: AlwaysStoppedAnimation<Color>(circularProgressIndicatorColor ?? Colors.white),
                      ))
              ],
            ));
  }
