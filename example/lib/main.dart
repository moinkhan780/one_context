        ...
        return OneNotification<OneThemeChangerEvent>(
            ...
            builder: (context, data) {
              return MaterialApp(
                ...
                theme: OneThemeController.initThemeData(
                    ThemeData(primarySwatch: Colors.green, primaryColor: Colors.green, brightness: Brightness.light)),
                  ...
                  onPressed: () async {
                    ...
                    var result = await OneContext().showDialog<String>(
                        ...
                        builder: (context) => AlertDialog(
                              ...
                              actions: <Widget>[
                                new TextButton(child: new Text("OK"), onPressed: () => OneContext().popDialog('ok')),
                                new TextButton(child: new Text("CANCEL"), onPressed: () => OneContext().popDialog('cancel')),
                              ],
                            ));
                    print(result);
                  },
                  ...
                  onPressed: () {
                    ...
                    OneContext().showBottomSheet(
                      ...
                      builder: (context) => Container(
                        ...
                        height: 200,
                        child: IconButton(
                            icon: Icon(Icons.arrow_drop_down), iconSize: 50, color: Colors.white, onPressed: () => OneContext().popDialog()),
                      ),
                    );
                  },
                ),
